...
def generate_norm_segm_from_coco(image_id, image_mean, is_vitruve, is_rect, is_man, is_rect_symmetrical, show):
    ...
    for dp_annotation in dp_annotations:
        ...
        if ('dp_masks' in dp_annotation.keys()):
            ...
            if show:
                ...
                _show_full_image(segm, dp_annotation, im_output)
        ...
        image = infer_segm.draw_segments_xy(segments_xy=segments_xy,
                                            is_vitruve=is_vitruve, is_rect=is_rect, is_man=is_man,
...
def visualize_mean(image_ids, output_fn, is_vitruve, is_rect, is_man, is_rect_symmetrical, show):
    ...
    for idx, image_id in enumerate(image_ids):
        ...
        try:
            # per person
            image_sum, image_count, _ = generate_norm_segm_from_coco(image_id=image_id, image_mean=None,
                                                                     is_vitruve=is_vitruve, is_rect=is_rect, is_man=is_man,
                                                                     is_rect_symmetrical=is_rect_symmetrical, show=show)
...
def visualize_std(image_ids, image_mean, output_fn, is_vitruve, is_rect, is_man, is_rect_symmetrical, show):
    ...
    for idx, image_id in enumerate(image_ids):
        ...
        try:
            # per person
            _, image_count, image_deviation_sum = generate_norm_segm_from_coco(image_id=image_id, image_mean=image_mean,
                                                                               is_vitruve=is_vitruve, is_rect=is_rect, is_man=is_man,
                                                                               is_rect_symmetrical=is_rect_symmetrical, show=show)
...
def visualize_dist(dp_img_category, dp_img_ids, is_vitruve, is_rect, is_rect_symmetrical, show):
    ...
    image_mean = visualize_mean(image_ids=dp_img_ids, output_fn=image_mean_output_fn,
                                is_vitruve=is_vitruve, is_rect=is_rect, is_man=is_man,
                                is_rect_symmetrical=is_rect_symmetrical, show=show)
    ...
    visualize_std(image_ids=dp_img_ids, image_mean=image_mean, output_fn=image_std_output_fn,
                  is_vitruve=is_vitruve, is_rect=is_rect, is_man=is_man,
                  is_rect_symmetrical=is_rect_symmetrical, show=False)
