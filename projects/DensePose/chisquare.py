...
classical = np.array([46.45, 38.62, 76.07, 16.66, 36.20, 75.24, 21.68, 156.17, 28.06, 76.85, 149.65, 25.21, 83.02, 125.58])
modern = np.array([49.07, 39.05, 78.26, 28.57, 38.58, 78.63, 26.40, 170.54, 28.19, 96.02, 127.18, 25.95, 94.53, 128.36])
...
obs = np.array([classical, modern]).T
print(obs.shape)
