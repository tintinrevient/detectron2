...
from visualize_rect_segm import (
    COARSE_TO_COLOR,
    _get_dict_of_midpoints, _segm_xy_centroid, _calc_angle
)
from visualize_rect_segm_coco import (
    _get_dp_mask, _get_dict_of_segm_and_keypoints
)
...
def visualize(image_id, person_index, category):
    ...
    for dp_annotation in dp_annotations:
        ...
        dict_norm_segm = df_contour.loc[category]
...
if __name__ == '__main__':
    ...
    visualize(image_id=image_id, person_index=1, category='coco')